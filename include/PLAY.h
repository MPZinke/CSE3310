...
enum PLAYTYPE {
    ...
    MESSAGE     ///CLIENT: Receive text message. SERVER: Receive and send text message.
};

/**
 * @brief All communications done through sending json versions of this class. Just holds relevant data.
 */
class PLAY{
    public:
        PLAY();
